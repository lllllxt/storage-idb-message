(function (global, factory) {
  ...
  */
  ...
  var databaseName = 'STORAGE_ORDER_DATA';
  ...
  var IDB_ORDER = /*#__PURE__*/function () {
    function IDB_ORDER() {
      ...
      var init = function init() {
        ...
        request.onsuccess = function (event) {
          console.log('✅打开数据库');
          IDB_ORDER.db = _this.db = event.target.result;
        };
        ...
        request.onupgradeneeded = function (event) {
          ...
          console.log('✅数据库创建/更新', _this.db, event);

          if (_this.db.objectStoreNames.contains('ORDER_DATA')) {
            _this.db.deleteObjectStore('ORDER_DATA');
          }
          ...
          objectStore.createIndex('order_name', 'order_name', {
            unique: false
          });
          objectStore.createIndex('order_value', 'order_value', {
            unique: false
          });
        };
      };

      isForce ? IDB_ORDER.clearCache(function () {
        return init();
      }) : init();
    }
    /** 新增/修改数据  */
    ...
    _createClass(IDB_ORDER, [{
      ...
      value: function get(orderName) {
        ...
        return new Promise(function (resolve, reject) {
          var request = _this4.db.transaction(['ORDER_DATA'], 'readonly').objectStore('ORDER_DATA').index('order_name').get(orderName);
      ...
      key: "clearCache",
      value: function clearCache(successFn, errFn) {
        var _this$db;

        this === null || this === void 0 ? void 0 : (_this$db = this.db) === null || _this$db === void 0 ? void 0 : _this$db.close();
  ...
  var StorageIdbMessage = /*#__PURE__*/function () {
    ...
    _createClass(StorageIdbMessage, [{
      ...
      key: "clearCache",
      value: function clearCache(successFn, errFn) {
        IDB_ORDER.clearCache(successFn, errFn);
      }
    }]);
